...
function Sidebar({sidebarToggle, toggleSidebar,  sideToggle}) {

   const { loginWithRedirect, isAuthenticated, logout } = useAuth0();

  return (
    <>
    <div className={`bg ${sidebarToggle ? 'show' : 'hide' }`}>  
<div id="separator-sidebar" className={`separator-sidebar ${sideToggle ? 'sho' : 'hid' }`} class="fixed top-0 left-0 z-40 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    {/*  */}
<i onClick={toggleSidebar}  id='x' class="fa-solid fa-x"></i>
{/*  */}
      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap" onClick={() => loginWithRedirect()}>Sign In</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               { isAuthenticated ? <span class="flex-1 ms-3 whitespace-nowrap" onClick={() => logout({ logoutParams: { returnTo: window.location.origin } })}>Log Out </span> : <span class="flex-1 ms-3 whitespace-nowrap" onClick={() => loginWithRedirect()}>Sign Up</span> }
